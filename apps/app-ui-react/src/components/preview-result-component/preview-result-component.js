...
import './preview-result-component.scss';
export function PreviewResultComponent({
  styles,
  ...props
}) {
  ...
  useEffect(() => {
    ...
    <head>
      ...
      <title>Bootstrap Theme Generator Preview</title>
      <style>
        ${styles}
      </style>
    </head>
  ...
  return (
    <iframe srcDoc={html} title="Bootstrap Theme Generator Preview" style={{
      width: '100%',
...
PreviewResultComponent.defaultProps = {
  styles: ''
}

export default PreviewResultComponent;
